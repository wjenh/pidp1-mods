...
drumupdater [-i drumimagefile] [-t trackno] [-l label] [sourcefile]
...
If no label is given, the default is the sourcefile without any leading path or trailing extension.
