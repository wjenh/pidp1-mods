// This is a utility to convert ascii characters to flex.
// The companion is flextoascii.c
// See below for use.
#define IN_FLEXLIB_C
#include "flexlib.h"
...
// If a shift is seen and we aren't in the correct shift state, become so and return the proper shift charater,
// CSHIFT or CUNSHIFT.
// The caller should then repeat the call with the original character to get the properly shifted one.
char
asciiToFlex(char ac, int *shiftP)
{
int fc;
