...
int dynamicIotProcessor(PDP1P pdpP, int device, int pulse, int completion);
void dynamicIotProcessorStart(void);
void dynamicIotProcessorStop(void);
void dynamicIotProcessorSetPDP1(PDP1P pdpP);
void dynamicIotProcessorDoPoll(PDP1P pdpP);
#endif
...
// The IOT handler implements a function 'int iotHandler(PDP1P pdp1P, int device, int pulse, int completion)'.
...
typedef int (*IotHandlerP)(PDP1P , int, int, int);
