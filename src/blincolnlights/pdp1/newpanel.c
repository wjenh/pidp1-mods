/*
 * This is a new implementation of the hardware panel driver for the pidp-1.
 * It uses data set by the emulator in a shared memory segment to update the panel lights
 * and to read the switches.
 *
 * Originally from the pidp-1 code by Angelo Papenhoff (aap)
 *
 * Written by: Bill Ezell (wje)
 *
 * wje 13-Mar-26 - initial work
 *
*/
#include "common.h"
